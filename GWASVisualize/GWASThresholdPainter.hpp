...
public:
    ...
    void preSetIsPaintInfo(bool flag)
    {
        isPaintInfo = flag;
    }
    void preSetIsPaintLine(bool flag)
    {
        isPaintLine = flag;
    }
...
private:
    ...
    void paintInfo(QPainter* painter)
    {
        ...
        fw = std::max(fontMetrics.horizontalAdvance(nText), fontMetrics.horizontalAdvance(valText));
        ...
        painter->drawText(xpos + 4, ypos + 6, fw, fh,
            Qt::AlignLeft | Qt::AlignTop, valText);
        painter->setPen(QPen(Qt::black, 1));
        painter->drawText(xpos + 4, ypos + fh + 6, fw, fh,
            Qt::AlignLeft | Qt::AlignTop, nText);
    }
};
