    ...
    :LoadBSAFileWidget(parent)
{
    ...
    connect(continueBtn,&QPushButton::clicked,
            this,&LoadBSAFileWidget::save);
    connect(cancelBtn,&QPushButton::clicked,
            this,&LoadBSAFileWidget::close);
    connect(openMarkerBtn,&QPushButton::clicked,
            this,&LoadBSAFileWidget::loadMarkerFile);
    connect(openChrLenBtn,&QPushButton::clicked,
            this,&LoadBSAFileWidget::loadChrLenFile);
    connect(fileFormBtn,&QPushButton::clicked,
            this,&LoadBSAFileWidget::viewFileForm);
